...
@CommandLine.Command(name = "listpendinginvoices", description = "List all non-paid BOLT-11 invoices.", sortOptions = false)
public class ListPendingInvoices extends BaseSubCommand {
  ...
  public Integer call() throws Exception {
    ...
    final ResponseBody body = http("listpendinginvoices", params);
    print(body.string());
