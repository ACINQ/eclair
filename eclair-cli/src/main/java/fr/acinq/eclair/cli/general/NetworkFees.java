...
@CommandLine.Command(name = "networkfees", description = "Retrieves the on-chain fees paid for channel operations. Amounts are in satoshis.", sortOptions = false)
public class NetworkFees extends BaseSubCommand {
  ...
  public Integer call() throws Exception {
    ...
    final ResponseBody body = http("networkfees", params);
    print(body.string());
