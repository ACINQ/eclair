  ...
  */
  ...
  test("last node replies with a long failure message (reference test vector)") {
    for ((payloads, packetPayloadLength) <- Seq((referencePaymentPayloads, 1300), (paymentPayloadsFull, 1300))) {
      ...
      val attribution = Attribution.create(None, Some(failurePacket), 1 millisecond, sharedSecret4)
      ...
      val attribution1 = Attribution.create(Some(attribution), Some(error), 2 milliseconds, sharedSecret3)
      ...
      val attribution2 = Attribution.create(Some(attribution1), Some(error1), 3 milliseconds, sharedSecret2)
      ...
      val attribution3 = Attribution.create(Some(attribution2), Some(error2), 4 milliseconds, sharedSecret1)
      ...
      val attribution4 = Attribution.create(Some(attribution3), Some(error3), 5 milliseconds, sharedSecret0)
  ...
  test("fulfilled HTLC with attribution data (reference test vector)") {
    for ((payloads, packetPayloadLength) <- Seq((referencePaymentPayloads, 1300), (paymentPayloadsFull, 1300))) {
      ...
      val attribution = Attribution.create(None, None, 1 millisecond, sharedSecret4)
      ...
      val attribution1 = Attribution.create(Some(attribution), None, 2 milliseconds, sharedSecret3)
      ...
      val attribution2 = Attribution.create(Some(attribution1), None, 3 milliseconds, sharedSecret2)
      ...
      val attribution3 = Attribution.create(Some(attribution2), None, 4 milliseconds, sharedSecret1)
      ...
      val attribution4 = Attribution.create(Some(attribution3), None, 5 milliseconds, sharedSecret0)
  ...
  test("only some nodes in the route support attributable failures") {
    for ((payloads, packetPayloadLength) <- Seq((referencePaymentPayloads, 1300), (paymentPayloadsFull, 1300))) {
      ...
      val attribution1 = Attribution.create(None, Some(error), 2 milliseconds, sharedSecret3)
      val error2 = FailurePacket.wrap(error1, sharedSecret2)
      val attribution2 = Attribution.create(Some(attribution1), Some(error1), 3 milliseconds, sharedSecret2)
      val error3 = FailurePacket.wrap(error2, sharedSecret1)
      val attribution3 = Attribution.create(Some(attribution2), Some(error2), 4 milliseconds, sharedSecret1)
