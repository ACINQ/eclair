  ...
  */
  ...
  test("last node replies with a long failure message (reference test vector)") {
    for ((payloads, packetPayloadLength) <- Seq((referencePaymentPayloads, 1300), (paymentPayloadsFull, 1300))) {
      ...
      val attribution = FailurePacket.attribution(None, failurePacket, 1 millisecond, sharedSecret4)
      ...
      val attribution1 = FailurePacket.attribution(Some(attribution), error, 2 millisecond, sharedSecret3)
      ...
      val attribution2 = FailurePacket.attribution(Some(attribution1), error1, 3 millisecond, sharedSecret2)
      ...
      val attribution3 = FailurePacket.attribution(Some(attribution2), error2, 4 millisecond, sharedSecret1)
      ...
      val attribution4 = FailurePacket.attribution(Some(attribution3), error3, 5 millisecond, sharedSecret0)
