  ...
  */
  ...
  test("fulfilled HTLC with attribution data (reference test vector)") {
    for ((payloads, packetPayloadLength) <- Seq((referencePaymentPayloads, 1300), (paymentPayloadsFull, 1300))) {
      ...
      val result = SuccessPacket.decrypt(None, Some(attribution4), sharedSecrets)
  ...
  test("fulfilled HTLC with attribution data and fulfillment payload (reference test vector)") {
    ...
    // The last node includes a fulfillment payload.
    val fulfillmentPayload = hex" fe0001000103070809"
    val fulfillmentPayload4 = SuccessPacket.create(sharedSecret4, fulfillmentPayload)
    assert(fulfillmentPayload4 == hex"")
    val attribution4 = Attribution.create(None, None, 100 millisecond, sharedSecret4)
    assert(attribution4 == hex"")

    val attribution3 = Attribution.create(Some(attribution4), Some(fulfillmentPayload4), 200 millisecond, sharedSecret3)
    assert(attribution3 == hex"")
    val fulfillmentPayload3 = SuccessPacket.wrap(fulfillmentPayload4, sharedSecret3)
    assert(fulfillmentPayload3 == hex"")

    val attribution2 = Attribution.create(Some(attribution3), Some(fulfillmentPayload3), 300 millisecond, sharedSecret2)
    assert(attribution2 == hex"")
    val fulfillmentPayload2 = SuccessPacket.wrap(fulfillmentPayload3, sharedSecret2)
    assert(fulfillmentPayload2 == hex"")

    val attribution1 = Attribution.create(Some(attribution2), Some(fulfillmentPayload2), 400 millisecond, sharedSecret1)
    assert(attribution1 == hex"")
    val fulfillmentPayload1 = SuccessPacket.wrap(fulfillmentPayload2, sharedSecret1)
    assert(fulfillmentPayload1 == hex"")

    val attribution0 = Attribution.create(Some(attribution1), Some(fulfillmentPayload1), 500 millisecond, sharedSecret0)
    assert(attribution0 == hex"")
    ...
    val result = SuccessPacket.decrypt(Some(fulfillmentPayload0), Some(attribution0), sharedSecrets)
    assert(result.fulfillmentPayload_opt.contains(fulfillmentPayload))
    assert(result.holdTimes == Seq(HoldTime(500 millisecond, publicKeys(0)), HoldTime(400 milliseconds, publicKeys(1)), HoldTime(300 milliseconds, publicKeys(2)), HoldTime(200 milliseconds, publicKeys(3)), HoldTime(100 milliseconds, publicKeys(4))))
  }
