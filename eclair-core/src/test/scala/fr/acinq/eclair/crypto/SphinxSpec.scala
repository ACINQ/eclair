  ...
  */
  ...
  test("last node replies with a long failure message (reference test vector)") {
    for ((payloads, packetPayloadLength) <- Seq((referencePaymentPayloads, 1300), (paymentPayloadsFull, 1300))) {
      ...
      val attribution = Attribution.create(None, failurePacket, 1 millisecond, sharedSecret4)
      ...
      val attribution1 = Attribution.create(Some(attribution), error, 2 milliseconds, sharedSecret3)
      ...
      val attribution2 = Attribution.create(Some(attribution1), error1, 3 milliseconds, sharedSecret2)
      ...
      val attribution3 = Attribution.create(Some(attribution2), error2, 4 milliseconds, sharedSecret1)
      ...
      val attribution4 = Attribution.create(Some(attribution3), error3, 5 milliseconds, sharedSecret0)
  ...
  test("fulfilled HTLC with attribution data (reference test vector)") {
    for ((payloads, packetPayloadLength) <- Seq((referencePaymentPayloads, 1300), (paymentPayloadsFull, 1300))) {
      ...
      val attribution = Attribution.create(None, ByteVector.empty, 1 millisecond, sharedSecret4)
      ...
      val attribution1 = Attribution.create(Some(attribution), ByteVector.empty, 2 milliseconds, sharedSecret3)
      ...
      val attribution2 = Attribution.create(Some(attribution1), ByteVector.empty, 3 milliseconds, sharedSecret2)
      ...
      val attribution3 = Attribution.create(Some(attribution2), ByteVector.empty, 4 milliseconds, sharedSecret1)
      ...
      val attribution4 = Attribution.create(Some(attribution3), ByteVector.empty, 5 milliseconds, sharedSecret0)
  ...
  test("only some nodes in the route support attributable failures") {
    for ((payloads, packetPayloadLength) <- Seq((referencePaymentPayloads, 1300), (paymentPayloadsFull, 1300))) {
      ...
      val attribution1 = Attribution.create(None, error, 2 milliseconds, sharedSecret3)
      val error2 = FailurePacket.wrap(error1, sharedSecret2)
      val attribution2 = Attribution.create(Some(attribution1), error1, 3 milliseconds, sharedSecret2)
      val error3 = FailurePacket.wrap(error2, sharedSecret1)
      val attribution3 = Attribution.create(Some(attribution2), error2, 4 milliseconds, sharedSecret1)
