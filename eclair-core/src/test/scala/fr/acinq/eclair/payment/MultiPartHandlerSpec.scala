...
class MultiPartHandlerSpec extends TestKitBaseClass with FixtureAnyFunSuiteLike {
  ...
  test("Invoice generation with route blinding support") { f =>
    ...
    val hop_ab = Router.ChannelHop(ShortChannelId(1), a, b, Router.HopRelayParams.FromHint(Invoice.ChannelEdge(a, b, ShortChannelId(1), 1000 msat, 699, CltvExpiryDelta(123))))
    val hop_bc = Router.ChannelHop(ShortChannelId(2), b, c, Router.HopRelayParams.FromHint(Invoice.ChannelEdge(b, c, ShortChannelId(2), 800 msat, 455, CltvExpiryDelta(78))))
    val hop_dc = Router.ChannelHop(ShortChannelId(3), d, c, Router.HopRelayParams.FromHint(Invoice.ChannelEdge(c, d, ShortChannelId(3), 0 msat, 1700, CltvExpiryDelta(89))))
    val hop_cc = Router.ChannelHop(ShortChannelId.toSelf, c, c, Router.HopRelayParams.FromHint(Invoice.ChannelEdge(c, c, ShortChannelId.toSelf, 0 msat, 0, CltvExpiryDelta(0))))
...
//    val edge1 = invoice.extraEdges(0)
//    val edge2 = invoice.extraEdges(1)
//    val edge3 = invoice.extraEdges(2)
//    assert(edge1.path.blindedNodeIds.length == 4)
//    assert(edge1.path.introductionNodeId == a)
//    assert(edge1.payInfo == PaymentInfo(1801 msat, 1155, CltvExpiryDelta(201), 0 msat, 25_000 msat, Features.empty))
//    assert(edge2.path.blindedNodeIds.length == 4)
//    assert(edge2.path.introductionNodeId == d)
//    assert(edge2.payInfo == PaymentInfo(0 msat, 1700, CltvExpiryDelta(89), 0 msat, 25_000 msat, Features.empty))
//    assert(edge3.path.blindedNodeIds.length == 1)
//    assert(edge3.path.introductionNodeId == c)
//    assert(edge3.payInfo == PaymentInfo(0 msat, 0, CltvExpiryDelta(0), 0 msat, 25_000 msat, Features.empty))
