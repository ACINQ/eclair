...
object MultiPartPaymentLifecycleSpec {
  ...
  val defaultChannelUpdate = ChannelUpdate(randomBytes64(), Block.RegtestGenesisBlock.hash, ShortChannelId(0), 0, ChannelUpdate.ChannelFlags(disable = false, direction = false), CltvExpiryDelta(12), 1 msat, 100 msat, 0, Some(2000000 msat))
