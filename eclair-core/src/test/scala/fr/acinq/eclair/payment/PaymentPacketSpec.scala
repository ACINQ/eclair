...
class PaymentPacketSpec extends AnyFunSuite with BeforeAndAfterAll {
  ...
  test("build outgoing trampoline payment (reference test vector)") {
    ...
    assert(payloadForEve == FinalPayload.Standard(TlvStream(AmountToForward(100_000_000 msat), OutgoingCltv(CltvExpiry(800_000)), PaymentData(ByteVector32.fromValidHex("2a2a2a2a2a2a2a2a2a2a2a2a2a2a2a2a2a2a2a2a2a2a2a2a2a2a2a2a2a2a2a2a"), 100_000_000 msat))))
  }
