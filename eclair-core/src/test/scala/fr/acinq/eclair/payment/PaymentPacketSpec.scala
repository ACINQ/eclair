  ...
  test("build outgoing trampoline payment (reference test vector)") {
    ...
    val onionForBob = {
      ...
      val payloads = Seq(
        ...
        NodePayload(carol, PaymentOnion.FinalPayload.Standard.createTrampolinePayload(100_005_000 msat, 100_005_000 msat, CltvExpiry(800_250), paymentSecret, trampolineOnionForCarol, upgradeAccountability = false)),
      )
    ...
    val onionForDave = {
      ...
      val payloads = Seq(
        ...
        NodePayload(eve, PaymentOnion.FinalPayload.Standard.createTrampolinePayload(100_000_000 msat, 100_000_000 msat, CltvExpiry(800_000), paymentSecret, trampolineOnionForEve, upgradeAccountability = false)),
      )
