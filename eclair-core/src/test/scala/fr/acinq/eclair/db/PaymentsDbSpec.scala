...
object PaymentsDbSpec {
  ...
  val hop_ab = ChannelHop(alice, bob, ChannelUpdate(randomBytes64(), randomBytes32(), ShortChannelId(42), 1, ChannelUpdate.ChannelFlags(disable = false, direction = false), CltvExpiryDelta(12), 1 msat, 1 msat, 1, None))
