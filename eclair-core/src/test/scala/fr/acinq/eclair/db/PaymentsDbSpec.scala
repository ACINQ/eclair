...
import fr.acinq.eclair.router.Router.{ChannelHop, ChannelSource, NodeHop}
...
object PaymentsDbSpec {
  ...
  val hop_ab = ChannelHop(ShortChannelId(42), alice, bob, ChannelSource.Announcement(ChannelUpdate(randomBytes64(), randomBytes32(), ShortChannelId(42), 1 unixsec, ChannelUpdate.ChannelFlags.DUMMY, CltvExpiryDelta(12), 1 msat, 1 msat, 1, None)))
