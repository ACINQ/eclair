...
class TestWallet extends EclairWallet {
  ...
  override def getReceivePubkey: Future[Crypto.PublicKey] = Future.successful(PublicKey(hex"028feba10d0eafd0fad8fe20e6d9206e6bd30242826de05c63f459a00aced24b12"))
