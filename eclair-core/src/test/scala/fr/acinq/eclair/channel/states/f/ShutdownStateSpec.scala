...
class ShutdownStateSpec extends TestkitBaseClass with StateTestsHelperMethods {
  ...
  override def withFixture(test: OneArgTest): Outcome = {
    ...
    within(30 seconds) {
      ...
      val expiry1 = CltvExpiryDelta(144).toCltvExpiry(alice.underlyingActor.nodeParams.blockCount.get())
      ...
      val expiry2 = CltvExpiryDelta(144).toCltvExpiry(alice.underlyingActor.nodeParams.blockCount.get())
