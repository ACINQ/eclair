...
abstract class BaseRouterSpec extends TestKitBaseClass with FixtureAnyFunSuiteLike {
  ...
  override def withFixture(test: OneArgTest): Outcome = {
    ...
    within(30 seconds) {
      ...
      sender.send(router, LocalChannelUpdate(sender.ref, null, channelId_ag, g, None, update_ag, CommitmentsSpec.makeCommitments(30000000 msat, 8000000 msat, a, g, announceChannel = false)))
