  ...
  test("cost function is monotonic") {
    ...
    val updates = SortedMap(
      ShortChannelId("565643x1216x0") -> PublicChannel(
        ...
        capacity = Satoshi(0),
        update_1_opt = Some(ChannelUpdate(ByteVector64.Zeroes, ByteVector32.Zeroes, ShortChannelId("565643x1216x0"), 0, 1.toByte, 0.toByte, 14, htlcMinimumMsat = MilliSatoshi(1), feeBaseMsat = MilliSatoshi(1000), 10, Some(MilliSatoshi(4294967295L)))),
        update_2_opt = Some(ChannelUpdate(ByteVector64.Zeroes, ByteVector32.Zeroes, ShortChannelId("565643x1216x0"), 0, 1.toByte, 1.toByte, 144, htlcMinimumMsat = MilliSatoshi(0), feeBaseMsat = MilliSatoshi(1000), 100, Some(MilliSatoshi(15000000000L))))
      ),
      ShortChannelId("542280x2156x0") -> PublicChannel(
        ...
        fundingTxid = ByteVector32.Zeroes,
        capacity = Satoshi(0),
        update_1_opt = Some(ChannelUpdate(ByteVector64.Zeroes, ByteVector32.Zeroes, ShortChannelId("542280x2156x0"), 0, 1.toByte, 0.toByte, 144, htlcMinimumMsat = MilliSatoshi(1000), feeBaseMsat = MilliSatoshi(1000), 100, Some(MilliSatoshi(16777000000L)))),
        update_2_opt = Some(ChannelUpdate(ByteVector64.Zeroes, ByteVector32.Zeroes, ShortChannelId("542280x2156x0"), 0, 1.toByte, 1.toByte, 144, htlcMinimumMsat = MilliSatoshi(1), feeBaseMsat = MilliSatoshi(667), 1, Some(MilliSatoshi(16777000000L))))
      ),
      ShortChannelId("565779x2711x0") -> PublicChannel(
        ...
        fundingTxid = ByteVector32.Zeroes,
        capacity = Satoshi(0),
        update_1_opt = Some(ChannelUpdate(ByteVector64.Zeroes, ByteVector32.Zeroes, ShortChannelId("565779x2711x0"), 0, 1.toByte, 0.toByte, 144, htlcMinimumMsat = MilliSatoshi(1), feeBaseMsat = MilliSatoshi(1000), 100, Some(MilliSatoshi(230000000L)))),
        update_2_opt = Some(ChannelUpdate(ByteVector64.Zeroes, ByteVector32.Zeroes, ShortChannelId("565779x2711x0"), 0, 1.toByte, 3.toByte, 144, htlcMinimumMsat = MilliSatoshi(1), feeBaseMsat = MilliSatoshi(1000), 100, Some(MilliSatoshi(230000000L))))
      )
    )
