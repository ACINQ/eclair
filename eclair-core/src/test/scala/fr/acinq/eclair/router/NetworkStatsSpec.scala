...
import fr.acinq.eclair.{CltvExpiryDelta, MilliSatoshi, MilliSatoshiLong, ShortChannelId, TimestampSecond, randomBytes32, randomBytes64, randomKey}
...
object NetworkStatsSpec {
  ...
  def fakeChannelUpdate1(cltv: CltvExpiryDelta, feeBase: MilliSatoshi, feeProportional: Long): ChannelUpdate = {
    ChannelUpdate(randomBytes64(), randomBytes32(), ShortChannelId(42), TimestampSecond(0), ChannelUpdate.ChannelFlags.DUMMY, cltv, 1 msat, feeBase, feeProportional, None)
  }

  def fakeChannelUpdate2(cltv: CltvExpiryDelta, feeBase: MilliSatoshi, feeProportional: Long): ChannelUpdate = {
    ChannelUpdate(randomBytes64(), randomBytes32(), ShortChannelId(42), TimestampSecond(0), ChannelUpdate.ChannelFlags(isNode1 = false, isEnabled = false), cltv, 1 msat, feeBase, feeProportional, None)
  }
