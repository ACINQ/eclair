...
class CommandCodecsSpec extends AnyFunSuite {
  ...
  test("encode/decode all settlement commands") {
    val testCases: Map[HtlcSettlementCommand, ByteVector] = Map(
      ...
      CMD_FAIL_HTLC(42456, FailureReason.EncryptedDownstreamFailure(hex"", None), TimestampMilli(123456)) -> hex"0005 000000000000a5d8 02 0091  0000 000000000001e240",
      CMD_FAIL_HTLC(253, FailureReason.LocalFailure(TemporaryNodeFailure()), TimestampMilli(123)) -> hex"0005 00000000000000fd 01 0002 2002 000000000000007b",
      CMD_FAIL_HTLC(253, FailureReason.LocalFailure(TemporaryNodeFailure(TlvStream(Set.empty[FailureMessageTlv], Set(GenericTlv(UInt64(17), hex"deadbeef"))))), TimestampMilli(456)) -> hex"0005 00000000000000fd 01 0008 2002 1104deadbeef 00000000000001c8",
  ...
  test("backward compatibility") {
    ...
    val testCases = Map(
      ...
      hex"0004 00000000000000fd 01 0002 2002" -> CMD_FAIL_HTLC(253, FailureReason.LocalFailure(TemporaryNodeFailure()), TimestampMilli.min),
      hex"0004 00000000000000fd 01 0008 2002 1104deadbeef" -> CMD_FAIL_HTLC(253, FailureReason.LocalFailure(TemporaryNodeFailure(TlvStream(Set.empty[FailureMessageTlv], Set(GenericTlv(UInt64(17), hex"deadbeef"))))), TimestampMilli.min),
    )
