...
class LightningMessageCodecsSpec extends FunSuite {
  ...
  test("encode/decode all channel messages") {
    ...
    val query_short_channel_id = QueryShortChannelId(Block.RegtestGenesisBlock.blockId, Seq(fr.acinq.eclair.toShortId(12346, 42, 1), fr.acinq.eclair.toShortId(12346, 43, 1)))
    val query_channel_range = QueryChannelRange(Block.RegtestGenesisBlock.blockId, 100000, 1500)
    val reply_channel_range = ReplyChannelRange(Block.RegtestGenesisBlock.blockId, 100000, 1500, randomBytes(3200))
    ...
    val msgs: List[LightningMessage] =
      open :: accept :: funding_created :: funding_signed :: funding_locked :: update_fee :: shutdown :: closing_signed ::
        ...
        channel_announcement :: node_announcement :: channel_update :: query_short_channel_id :: query_channel_range :: reply_channel_range :: announcement_signatures :: ping :: pong :: channel_reestablish :: Nil
