...
class LightningMessageCodecsSpec extends AnyFunSuite {
  ...
  test("encode/decode closing_signed") {
    val defaultSig = ByteVector64.fromValidHex("01010101010101010101010101010101010101010101010101010101010101010101010101010101010101010101010101010101010101010101010101010101")
    val testCases = Seq(
