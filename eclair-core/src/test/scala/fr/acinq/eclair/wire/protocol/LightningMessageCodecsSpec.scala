...
class LightningMessageCodecsSpec extends AnyFunSuite {
  ...
  test("encode/decode interactive-tx messages") {
    ...
    val testCases = Seq(
      ...
      TxAddInput(channelId1, UInt64(561), OutPoint(tx1, 1), tx1.txOut(1), 5) -> hex"0042 aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa 0000000000000231 0000 00000001 00000005 003f1f2ec025a33e39ef8e177afcdc1adc855bf128dc906182255aeb64efa825f106000000000003e763a9143638b2602d11f934c04abc6adb1494f69d1f14af87",
