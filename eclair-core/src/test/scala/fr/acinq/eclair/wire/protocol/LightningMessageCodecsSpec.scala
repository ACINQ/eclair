...
import fr.acinq.bitcoin.scalacompat.{Block, BlockHash, ByteVector32, ByteVector64, OutPoint, SatoshiLong, Script, ScriptWitness, Transaction, TxId}
...
class LightningMessageCodecsSpec extends AnyFunSuite {
  ...
  test("encode/decode init message") {
    ...
    val testCases = Seq(
      ...
      TestCase(hex"0000 0002088a fd053b150001000e000186a00007a120022600641388000101", hex"088a", Nil, None, valid = true), // one liquidity ads with the default payment type
      TestCase(hex"0000 0002088a fd053b3d0002000e000186a00007a120022600641388000c0007a120004c4b40044c004b001b080000000000000000000300000000000000000000000000000001", hex"088a", Nil, None, valid = true) // two liquidity ads with multiple payment types
    )
