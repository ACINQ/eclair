...
class OnionCodecsSpec extends FunSuite {
  ...
  test("encode/decode variable-length (tlv) final per-hop payload") {
    val testCases = Map(
      ...
      TlvStream[OnionTlv](Seq(AmountToForward(561 msat), OutgoingCltv(CltvExpiry(42))), Seq(GenericTlv(5482373485L, hex"16c7ec71663784ff100b6eface1e60a97b92ea9d18b8ece5e558586bc7453828"))) -> hex"31 02020231 04012aff0000000146c6616d20 16c7ec71663784ff100b6eface1e60a97b92ea9d18b8ece5e558586bc7453828"
    )
