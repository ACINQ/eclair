...
object TestConstants {
  ...
  object Alice {
    ...
    def channelParams: LocalParams = Peer.makeChannelParams(
      ...
      requestedChannelReserve = 10_000 sat // Bob will need to keep that much satoshis in his balance
    )
  }
  ...
  object Bob {
    ...
    def channelParams: LocalParams = Peer.makeChannelParams(
      ...
      requestedChannelReserve = 20_000 sat // Alice will need to keep that much satoshis in her balance
    )
  }
