...
class StartupSpec extends AnyFunSuite {
  ...
  def makeNodeParamsWithDefaults(conf: Config): NodeParams = {
    ...
    NodeParams.makeNodeParams(conf, UUID.fromString("01234567-0123-4567-89ab-0123456789ab"), nodeKeyManager, channelKeyManager, onchainKeyManager, None, db, blockCount, feeEstimator)
  }
