 ...
 */
case class TransactionPublished(channelId: ByteVector32, remoteNodeId: PublicKey, tx: Transaction, localMiningFee: Satoshi, remoteMiningFee: Satoshi, desc: String, timestamp: TimestampMilli = TimestampMilli.now()) extends ChannelEvent {
