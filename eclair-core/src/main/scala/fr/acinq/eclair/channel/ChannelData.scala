...
object HtlcResult {
  ...
  case class DisconnectedBeforeSigned(channelUpdate: ChannelUpdate) extends Fail { assert(channelUpdate.channelFlags.disable, "channel update must have disabled flag set") }
}
