...
final case class CMD_FORCECLOSE(replyTo: ActorRef, maxClosingFeerate_opt: Option[FeeratePerKw] = None, resetFundingTxIndex_opt: Option[Int] = None, overrideOutdatedCommitment: Boolean = false) extends CloseCommand
