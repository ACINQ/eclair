...
final case class RES_HOSTED_GETINFO(nodeId: PublicKey, channelId: ByteVector32, state: State, commits: HOSTED_DATA_COMMITMENTS, nextLocalSpec: CommitmentSpec, pendingRelays: Seq[HasHtlcIdCommand])
