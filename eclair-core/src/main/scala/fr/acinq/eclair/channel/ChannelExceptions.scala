...
case class ForcedLocalCommit                       (override val channelId: ByteVector32, overrideOutdatedCommitment: Boolean) extends ChannelException(channelId, s"forced local commit")
