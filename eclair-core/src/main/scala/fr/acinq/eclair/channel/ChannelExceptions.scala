...
case class CommitSigMissing                        (override val channelId: ByteVector32, fundingTxId: ByteVector32) extends ChannelException(channelId, s"commit sig missing for commitment with fundingTxId=$fundingTxId")
