...
case class FundingTxTimedout                   (channelId: BinaryData) extends ChannelException(channelId, "funding tx timed out")
case class FundingTxSpent                      (channelId: BinaryData, spendingTx: Transaction) extends ChannelException(channelId, s"funding tx has been spent by txid=${spendingTx.txid}")
case class HtlcTimedout                        (channelId: BinaryData) extends ChannelException(channelId, "one or more htlcs timed out")
