...
case class HtlcOverriddenByLocalCommit         (override val channelId: ByteVector32, htlcs: Set[UpdateAddHtlc]) extends ChannelException(channelId, "htlc was overridden by local commit")
