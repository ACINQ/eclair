...
object InteractiveTxBuilder {
  ...
  object SharedFundingInput {
    def apply(commitment: Commitment): SharedFundingInput = commitment.redeemInfo match {
      case _: RedeemInfo.SegwitV0 => Multisig2of2Input(commitment.commitInput, commitment.redeemInfo, commitment.fundingTxIndex, commitment.remoteFundingPubKey)
      case _: RedeemInfo.TaprootKeyPath => Musig2Input(commitment.commitInput, commitment.redeemInfo, commitment.fundingTxIndex, commitment.remoteFundingPubKey)
    }
  }
  ...
  case class Musig2Input(info: InputInfo, redeemInfo: RedeemInfo.TaprootKeyPathOrSegwitV0, fundingTxIndex: Long, remoteFundingPubkey: PublicKey) extends SharedFundingInput {
