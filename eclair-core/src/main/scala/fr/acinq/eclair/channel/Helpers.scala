  ...
  object Closing {
    ...
    object MutualClose {
      ...
      def makeClosingTx(keyManager: ChannelKeyManager, commitment: FullCommitment, localScriptPubkey: ByteVector, remoteScriptPubkey: ByteVector, closingFees: ClosingFees)(implicit log: LoggingAdapter): (ClosingTx, ClosingSigned) = {
        ...
        require(isValidFinalScriptPubkey(localScriptPubkey, allowAnySegwit, allowOpReturn = false), "invalid localScriptPubkey")
        require(isValidFinalScriptPubkey(remoteScriptPubkey, allowAnySegwit, allowOpReturn = false), "invalid remoteScriptPubkey")
