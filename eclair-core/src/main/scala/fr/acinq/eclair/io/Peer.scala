    ...
    dropStaleMessages {
      ...
      case Event(SpawnChannelInitiator(replyTo, c, channelConfig, channelType, localParams), d: ConnectedData) =>
        ...
        val init = INPUT_INIT_CHANNEL_INITIATOR(
          ...
          commitTxFeerate = nodeParams.onChainFeeConf.getCommitmentFeerate(nodeParams.currentBitcoinCoreFeerates, remoteNodeId, channelType.commitmentFormat, c.fundingAmount),
          ...
          maxHtlcValueInFlight = nodeParams.channelConf.maxHtlcValueInFlight(c.fundingAmount, unlimited = c.disableMaxHtlcValueInFlight),
          maxAcceptedHtlcs = nodeParams.channelConf.maxAcceptedHtlcs,
          toRemoteDelay = nodeParams.channelConf.toRemoteDelay,
              ...
              open match {
                case Left(open) =>
                  val init = INPUT_INIT_CHANNEL_NON_INITIATOR(
                    ...
                    dustLimit = nodeParams.channelConf.dustLimit,
                    htlcMinimum = nodeParams.channelConf.htlcMinimum,
                    maxHtlcValueInFlight = nodeParams.channelConf.maxHtlcValueInFlight(open.fundingSatoshis, unlimited = false),
                    maxAcceptedHtlcs = nodeParams.channelConf.maxAcceptedHtlcs,
                    toRemoteDelay = nodeParams.channelConf.toRemoteDelay,
                    remote = d.peerConnection,
                    remoteInit = d.remoteInit,
                ...
                case Right(open) =>
                  val init = INPUT_INIT_CHANNEL_NON_INITIATOR(
                    ...
                    dustLimit = nodeParams.channelConf.dustLimit,
                    htlcMinimum = nodeParams.channelConf.htlcMinimum,
                    maxHtlcValueInFlight = nodeParams.channelConf.maxHtlcValueInFlight(open.fundingAmount + addFunding_opt.map(_.fundingAmount).getOrElse(0 sat), unlimited = false),
                    maxAcceptedHtlcs = nodeParams.channelConf.maxAcceptedHtlcs,
                    toRemoteDelay = nodeParams.channelConf.toRemoteDelay,
                    remote = d.peerConnection,
                    remoteInit = d.remoteInit,
