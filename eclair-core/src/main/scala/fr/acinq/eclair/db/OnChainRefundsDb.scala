...
trait OnChainRefundsDb {
  def addSettlingOnChain(paymentSettlingOnChain: PaymentSettlingOnChain): Unit

  def addLostOnChain(paymentLostOnChain: PaymentLostOnChain): Unit
