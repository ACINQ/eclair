  ...
  private def extractPublicKey(address: String)(implicit ec: ExecutionContext): Future[PublicKey] = {
    for {
      ...
      if (useEclairSigner) {
        ...
        val computed = onchainKeyManager.getPublicKey(DeterministicWallet.KeyPath(keyPath1))
        require(computed == (extracted, address), "cannot recompute pubkey generated by bitcoin core")
      }
      extracted
    }
  }
