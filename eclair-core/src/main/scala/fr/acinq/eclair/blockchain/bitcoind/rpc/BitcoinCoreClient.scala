...
object BitcoinCoreClient {
   ...
   * We only defined values for the type that we actually use
   */
  sealed trait AddressType {
    /**
     *
     * @return the name of this address type as used by bitcoin core in configuration files and RPC calls
     */
    def bitcoinCoreName: String
  }

  object AddressType {
    case object P2wpkh extends AddressType {
      override def bitcoinCoreName: String = "bech32"
    }

    case object P2tr extends AddressType {
      override def bitcoinCoreName: String = "bech32m"
    }
  }
}