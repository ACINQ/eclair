      ...
      .flatMap { c =>
        ...
        val htlcsToIgnore: Set[Long] = c match {
          case d: DATA_CLOSING =>
            ...
            val channelKeys = d.getChannelKeys.getOrElse(nodeParams.channelKeyManager.channelKeys(d.commitments.channelParams.channelConfig, d.commitments.localChannelParams.fundingKeyPath))
