...
object PaymentLifecycle {
  ...
  case class PaymentSucceeded(id: UUID, amountMsat: Long, paymentHash: BinaryData, paymentPreimage: BinaryData, route: Seq[Hop]) extends PaymentResult // note: the amount includes fees
  ...
  case class PaymentFailed(id: UUID, paymentHash: BinaryData, failures: Seq[PaymentFailure]) extends PaymentResult
  ...
  def buildCommand(id: UUID, finalAmountMsat: Long, finalExpiry: Long, paymentHash: BinaryData, hops: Seq[Hop]): (CMD_ADD_HTLC, Seq[(BinaryData, PublicKey)]) = {
