...
private[channel] object ChannelCodecs5 {
  ...
  private[version5] object Codecs {
    ...
    private val remoteChannelParamsCodec: Codec[RemoteChannelParams] = (
      ("nodeId" | publicKey) ::
        ("channelReserve" | optional(bool8, satoshi)) ::
    ...
    private val dualFundingStatusCodec: Codec[DualFundingStatus] = discriminated[DualFundingStatus].by(uint8)
