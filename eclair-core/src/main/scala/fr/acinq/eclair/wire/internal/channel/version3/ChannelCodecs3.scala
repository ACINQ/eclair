...
import fr.acinq.bitcoin.scalacompat.{ByteVector32, OutPoint, Script, ScriptElt, Transaction, TxOut}
...
private[channel] object ChannelCodecs3 {
  ...
  private[version3] object Codecs {
    ...
    private val missingPaymentHashCodec: Codec[RipemdOfPaymentHash] = provide(RipemdOfPaymentHash.empty)
