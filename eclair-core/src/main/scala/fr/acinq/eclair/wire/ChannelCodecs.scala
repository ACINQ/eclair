...
object ChannelCodecs extends Logging {
  ...
  val htlcCodec: Codec[DirectedHtlc] = discriminated[DirectedHtlc].by(boolean)
  ...
  val htlcTxAndSigsCodec: Codec[HtlcTxAndSigs] = (
    ("txinfo" | txWithInputInfoCodec) ::
      ("localSig" | lengthDelimited(sig64OrDERCodec)) :: // we store as variable length for historical purposes (we used to store as DER encoded)
      ("remoteSig" | lengthDelimited(sig64OrDERCodec))).as[HtlcTxAndSigs]
  ...
  val waitingForRevocationCodec: Codec[WaitingForRevocation] = (
    ("nextRemoteCommit" | remoteCommitCodec) ::
      ...
      ("reSignAsap" | boolean)).as[WaitingForRevocation]
  ...
  val localCommitPublishedCodec: Codec[LocalCommitPublished] = (
    ("commitTx" | txCodec) ::
      ("claimMainDelayedOutputTx" | optional(boolean, txCodec)) ::
  ...
  val remoteCommitPublishedCodec: Codec[RemoteCommitPublished] = (
    ("commitTx" | txCodec) ::
      ("claimMainOutputTx" | optional(boolean, txCodec)) ::
  ...
  val revokedCommitPublishedCodec: Codec[RevokedCommitPublished] = (
    ("commitTx" | txCodec) ::
      ("claimMainOutputTx" | optional(boolean, txCodec)) ::
      ("mainPenaltyTx" | optional(boolean, txCodec)) ::
  ...
  val DATA_WAIT_FOR_FUNDING_CONFIRMED_Codec: Codec[DATA_WAIT_FOR_FUNDING_CONFIRMED] = (
    ("commitments" | commitmentsCodec) ::
      ("fundingTx" | optional(boolean, txCodec)) ::
      ("waitingSince" | int64) ::
      ("deferred" | optional(boolean, lengthDelimited(fundingLockedCodec))) ::
      ("lastSent" | either(boolean, lengthDelimited(fundingCreatedCodec), lengthDelimited(fundingSignedCodec)))).as[DATA_WAIT_FOR_FUNDING_CONFIRMED]
  ...
  val DATA_NORMAL_Codec: Codec[DATA_NORMAL] = (
    ("commitments" | commitmentsCodec) ::
      ("shortChannelId" | shortchannelid) ::
      ("buried" | boolean) ::
      ("channelAnnouncement" | optional(boolean, lengthDelimited(channelAnnouncementCodec))) ::
      ("channelUpdate" | lengthDelimited(channelUpdateCodec)) ::
      ("localShutdown" | optional(boolean, lengthDelimited(shutdownCodec))) ::
      ("remoteShutdown" | optional(boolean, lengthDelimited(shutdownCodec)))).as[DATA_NORMAL]
  ...
  val DATA_NEGOTIATING_Codec: Codec[DATA_NEGOTIATING] = (
    ("commitments" | commitmentsCodec) ::
      ...
      ("bestUnpublishedClosingTx_opt" | optional(boolean, txCodec))).as[DATA_NEGOTIATING]
  ...
  val DATA_CLOSING_Codec: Codec[DATA_CLOSING] = (
    ("commitments" | commitmentsCodec) ::
      ...
      ("localCommitPublished" | optional(boolean, localCommitPublishedCodec)) ::
      ("remoteCommitPublished" | optional(boolean, remoteCommitPublishedCodec)) ::
      ("nextRemoteCommitPublished" | optional(boolean, remoteCommitPublishedCodec)) ::
      ("futureRemoteCommitPublished" | optional(boolean, remoteCommitPublishedCodec)) ::
