...
import fr.acinq.eclair.wire.internal.channel.MigrationUtils
import grizzled.slf4j.Logging
import scodec.codecs._
import scodec.{Attempt, Codec}


private[channel] object ChannelCodecs1 extends Logging {
  ...
  private[version1] object Codecs {
    ...
    val closingTxCodec: Codec[ClosingTx] = txCodec.xmap(
      tx => MigrationUtils.migrateClosingTx(tx),
    ...
    val localCommitPublishedCodec: Codec[LocalCommitPublished] = (
      ("commitTx" | txCodec) ::
        ...
        ("spent" | spentMapCodec)).as[MigrationUtils.LegacyLocalCommitPublished].decodeOnly.map[LocalCommitPublished](_.migrate()).decodeOnly
    ...
    val remoteCommitPublishedCodec: Codec[RemoteCommitPublished] = (
      ("commitTx" | txCodec) ::
        ...
        ("spent" | spentMapCodec)).as[MigrationUtils.LegacyRemoteCommitPublished].decodeOnly.map[RemoteCommitPublished](_.migrate()).decodeOnly
    ...
    val revokedCommitPublishedCodec: Codec[RevokedCommitPublished] = (
      ("commitTx" | txCodec) ::
        ...
        ("spent" | spentMapCodec)).as[MigrationUtils.LegacyRevokedCommitPublished].decodeOnly.map[RevokedCommitPublished](_.migrate()).decodeOnly
