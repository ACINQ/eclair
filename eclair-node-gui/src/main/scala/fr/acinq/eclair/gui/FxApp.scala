...
class FxApp extends Application with Logging {
  ...
  override def start(primaryStage: Stage): Unit = {
    ...
    def onError(t: Throwable): Unit = t match {
      ...
      case IncompatibleDBException(version) =>
        ...
        notifyPreloader(new AppNotification(InfoAppNotification, "Please remove the 'db' folder in your datadir to proceed with this version."))
      case t: Throwable =>
