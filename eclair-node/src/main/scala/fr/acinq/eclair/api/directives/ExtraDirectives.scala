...
import fr.acinq.eclair.{MilliSatoshi, ShortChannelId, TimestampMilli, TimestampSecond}
...
trait ExtraDirectives extends Directives {
  ...
  val fromFormParam: NameDefaultUnmarshallerReceptacle[TimestampSecond] = "from".as[TimestampSecond](timestampSecondUnmarshaller).?(TimestampSecond(0))
  val toFormParam: NameDefaultUnmarshallerReceptacle[TimestampSecond] = "to".as[TimestampSecond](timestampSecondUnmarshaller).?(TimestampSecond(Long.MaxValue))
