...
class CodecsSpec extends FunSuite {
  ...
  test("encode/decode all channel messages") {
    ...
    val funding_locked = FundingLocked(1, 2, Some(randomSignature), Some(randomSignature), bin(33, 2))
    ...
    val revoke_and_ack = RevokeAndAck(1, bin(32, 0), bin(33, 1), randomSignature :: randomSignature :: randomSignature :: randomSignature :: randomSignature :: Nil)
