...
class RouterSpec extends FunSuite {
  ...
  test("calculate simple route") {
    ...
    val route = IRCRouter.findRouteDijkstra(BinaryData("01"), BinaryData("05"), channels)
  ...
  test("calculate simple route 2") {
    ...
    val route = IRCRouter.findRouteDijkstra(BinaryData("032b2e37d202658eb5216a698e52da665c25c5d04de0faf1d29aa2af7fb374a003"), BinaryData("023cda4e9506ce0a5fd3e156fc6d1bff16873375c8e823ee18aa36fa6844c0ae61"), channels)
  ...
  test("calculate simple route 3") {
    ...
    val route = IRCRouter.findRouteDijkstra(BinaryData("03befb4f8ad1d87d4c41acbb316791fe157f305caf2123c848f448975aaf85c1bb"), BinaryData("021acf75c92318d3723098294d2a6a4b08d9abba2ebb5f2df2b4a8e9153e96a5f4"), channels)
  ...
  test("route not found") {
    ...
    intercept[RuntimeException] {
      IRCRouter.findRouteDijkstra(BinaryData("03befb4f8ad1d87d4c41acbb316791fe157f305caf2123c848f448975aaf85c1bb"), BinaryData("021acf75c92318d3723098294d2a6a4b08d9abba2ebb5f2df2b4a8e9153e96a5f4"), channels)
    }
  }
  ...
  test("route to self") {
    ...
    intercept[RuntimeException] {
      IRCRouter.findRouteDijkstra(BinaryData("01"), BinaryData("01"), channels)
    }
  }
