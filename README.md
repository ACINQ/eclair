...
Eclair needs a _synchronized_, _segwit-ready_, **_zeromq-enabled_**, wallet-enabled, _non-pruning_, _tx-indexing_ [Bitcoin Core](https://github.com/bitcoin/bitcoin) node. This means that on Windows you will need Bitcoin Core 0.14+.
