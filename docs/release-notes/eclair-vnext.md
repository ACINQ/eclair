...
- `findroute`, `findroutetonode` and `findroutebetweennodes` let you choose the format of the route returned with the `--routeFormat` parameter (supported values are `nodeId`, `shortChannelId` and `full`) (#1943, #1969)
